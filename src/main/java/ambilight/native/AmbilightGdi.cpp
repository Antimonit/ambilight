...
#include <wingdi.h>
#include <iostream>
#include "ambilight_AmbilightGdi.h"
...
JNIEXPORT void JNICALL Java_ambilight_AmbilightGdi_nativeSaveScreenshotToClipboard(JNIEnv* env, jobject obj) {
    BlitFullSize();
...
JNIEXPORT jobjectArray JNICALL Java_ambilight_AmbilightGdi_nativeGetScreenSegmentsColorBytes(JNIEnv* env, jobject obj) {
...
JNIEXPORT void JNICALL Java_ambilight_AmbilightGdi_nativeInit(JNIEnv* env, jobject obj, jint ledsWidth, jint ledsHeight, jobjectArray jleds) {
